...
{
    return pow((x[0] - 3), 2) + pow((x[1] + 5), 2) + pow((x[1] - 12), 2);
}
...
void n_dimensional_test_suite(int num_dimensions, int NUM_ITERS, double MIN, double MAX, default_random_engine eng, uniform_real_distribution<double> distr)
{
...
int main()
{
    ...
    {
        n_dimensional_test_suite(num_dimensions, NUM_ITERS, MIN, MAX, eng, distr);
    }
    return 0;
}